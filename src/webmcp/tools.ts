...
export const TOOL_SUMMARIES: Record<string, string> = {
  ...
  get_current_decision: "The open round: seats, defenses, what still blocks.",
  get_decision_history: "Past arenas, newest first.",
  get_founder_track_record: "How this founder has missed, with sample sizes.",
  add_argument: "A seat claim on the table, not in chat.",
  ...
  stress_test_decision: "Hero. Seats the five perspectives. Table fills.",
