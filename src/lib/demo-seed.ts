...
const decisions: Decision[] = [
  ...
  },
  {
    id: "dec_demo06",
    companyId: COMPANY_ID,
    question: "Should we launch the hosted waitlist in March?",
    context: "Billing was unfinished. The waitlist was warm.",
    options: [
      { id: "opt_a", label: "Launch in March", detail: "Open the waitlist with what we had." },
      { id: "opt_b", label: "Wait", detail: "Another month of polish first." },
    ],
    status: "abandoned",
    founderConfidence: 58,
    agentConfidence: 41,
    chosenOptionId: "opt_b",
    commitmentRationale: "Wait — another month of polish first.",
    round: 1,
  ...
  },
  {
    id: "dec_demo07",
    companyId: COMPANY_ID,
    question: "Ship a public launch this quarter, or hold?",
    context: "Show HN traffic was already going cold.",
    options: [
      { id: "opt_a", label: "Ship this quarter", detail: "Take the remaining attention." },
      { id: "opt_b", label: "Hold", detail: "Finish the migration path first." },
    ],
    status: "abandoned",
    founderConfidence: 51,
    agentConfidence: 39,
    chosenOptionId: "opt_b",
    commitmentRationale: "Not yet. Delay until the migration path is done.",
    round: 1,
  ...
  },
  {
    id: "dec_demo08",
    companyId: COMPANY_ID,
    question: "Go to market with the invite-only relay?",
    context: "Nine months of runway. No one had been asked to pay.",
    options: [
      { id: "opt_a", label: "Open it", detail: "Invite-only, but charging." },
      { id: "opt_b", label: "Stay closed", detail: "Keep polishing the self-serve path." },
    ],
    status: "investigating",
    founderConfidence: 47,
    agentConfidence: 36,
    round: 1,
  ...
  },
  {
    id: "dec_demo09",
    companyId: COMPANY_ID,
    question: "Release the TypeScript core to the waitlist?",
    context: "The Rust rewrite had already slipped once.",
    options: [
      { id: "opt_a", label: "Release it", detail: "Give them something to run." },
      { id: "opt_b", label: "Hold for Rust", detail: "Launch later once the rewrite lands." },
    ],
    status: "abandoned",
    founderConfidence: 44,
    agentConfidence: 48,
    chosenOptionId: "opt_b",
    commitmentRationale: "Hold. Launch later once Rust is done.",
    round: 1,
